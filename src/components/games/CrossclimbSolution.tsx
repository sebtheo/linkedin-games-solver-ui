...
const CrossclimbSolution: React.FC<CrossclimbSolutionProps> = ({ solution }) => {
  return (
    <GameCard gameInfo={getGameInfo('crossclimb')}>
      <div className="flex flex-col items-center">
        ...
        <div className="text-sm text-slate-600 dark:text-slate-400 mt-6">
          <p>Crossclimb requires changing one letter at a time to reach the target word.</p>
        </div>
      </div>
    </GameCard>
  );
