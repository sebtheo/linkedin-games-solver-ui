...
const TangoSolution: React.FC<TangoSolutionProps> = ({ solution }) => {
  return (
    <GameCard gameInfo={getGameInfo('tango')}>
      <div className="text-center">
        ...
        <div className="text-sm text-slate-600 dark:text-slate-400 mt-4">
          <p>Tango challenges you to identify the pattern in a series of binary digits.</p>
        </div>
      </div>
    </GameCard>
  );
