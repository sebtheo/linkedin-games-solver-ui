...
const ZipSolution: React.FC<ZipSolutionProps> = ({
  solution,
  sequence,
  gridSize,
  isExpanded,
    ...
    >
      <div className="text-center">
        ...
        <div className="text-sm text-slate-600 dark:text-slate-400 mt-4">
          <p>
            Zip requires connecting dots in numerical order to reveal a hidden
            pattern.
          </p>
        </div>
      </div>
